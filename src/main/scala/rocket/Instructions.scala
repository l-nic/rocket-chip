...
object Instructions {
  ...
  def REVS               = BitPat("b0101010??????????000?????0110011")
  def REVI               = BitPat("b0101010??????????001?????0110011")
  def REVL               = BitPat("b0101010??????????010?????0110011")
...
object CSRs {
  ...
  // lnicucmd us used by apps to send cmds to the LNIC
